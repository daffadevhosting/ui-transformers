...
<html lang="id-ID">
  <head>
    ...
    <body class="bg-gray-50 flex flex-col justify-center items-center min-h-screen text-center p-6">
      ...
      <p class="text-gray-600 max-w-md">Tapi saat ini Lyra pindah ke kesini 👉 <a href="https://daffadevhosting.github.io/daffadevhosting/" class="text-clifford font-bold">UI-Generator</a> yuuu dicoba.. 😉️</p>
    </body>
</html>`;
